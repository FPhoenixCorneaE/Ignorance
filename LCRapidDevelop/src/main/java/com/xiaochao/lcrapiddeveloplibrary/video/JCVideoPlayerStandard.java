...
public class JCVideoPlayerStandard extends JCVideoPlayer {
    ...
    public int getLayoutId() {
        return R.layout.jcvp_layout_standard;
    }
    ...
    protected void showProgressDialog(float deltaX, String seekTime, int seekTimePosition, String totalTime, int totalTimeDuration) {
        ...
        if (mProgressDialog == null) {
            View localView = LayoutInflater.from(getContext()).inflate(R.layout.jcvp_progress_dialog, null);
    ...
    protected void showVolumDialog(float deltaY, int volumePercent) {
        ...
        if (mVolumeDialog == null) {
            View localView = LayoutInflater.from(getContext()).inflate(R.layout.jcvp_volume_dialog, null);
