...
import com.zhl.cbdialog.materialishprogress.ProgressWheel;
import com.zhl.cbdialog.sweetalert.ProgressHelper;
...
public class CBDialogBuilder {
    ...
    private static final int ITEM_TEXT_COLOR = R.color.item_text_color;
    private static final int ITEM_SELECTED_TEXT_COLOR = R.color.item_text_color_pressed;
    private static final int ITEM_BACKGROUNDRES = R.color.color_transparent;
    private static final int ITEM_SELECTED_BACKGROUNDRES = R.drawable.item_tx_background;
    /**
    ...
    private int itemSelectedBackgroundRes;
    /**
    ...
    public CBDialogBuilder setItemBackgroundRes(int itemBackgroundRes) {
        this.itemBackgroundRes = itemBackgroundRes;
        return this;
    }

    public CBDialogBuilder setItemSelectedBackgroundRes(int itemSelectedBackgroundRes) {
        this.itemSelectedBackgroundRes = itemSelectedBackgroundRes;
        return this;
    }

    public CBDialogBuilder setItemSelectedTextColor(int itemSelectedTextColor) {
        this.itemSelectedTextColor = itemSelectedTextColor;
        return this;
    }

    public CBDialogBuilder setItemTextColorStateList(ColorStateList itemTextColorStateList) {
        this.itemTextColorStateList = itemTextColorStateList;
        return this;
    }

    public CBDialogBuilder setItemTextColor(int itemTextColor) {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (position == selectedPos) {
                if (itemSelectedTextColor != 0) {
                    viewHolder.txView.setTextColor(itemSelectedTextColor);
                } else {
                    viewHolder.txView.setTextColor(context.getResources().getColor(
                            ITEM_SELECTED_TEXT_COLOR));
                }
                if (itemSelectedBackgroundRes != 0) {
                    viewHolder.txView
                            .setBackgroundResource(itemSelectedBackgroundRes);
                } else {
                    viewHolder.txView
                            .setBackgroundResource(ITEM_SELECTED_BACKGROUNDRES);
                }
            } else {
                if (itemTextColorStateList != null) {
                    viewHolder.txView.setTextColor(itemTextColorStateList);
                } else if (itemTextColor != 0) {
                    viewHolder.txView.setTextColor(itemTextColor);
                } else {
                    viewHolder.txView.setTextColor(context.getResources().getColor(
                            ITEM_TEXT_COLOR));
                }
                if (itemBackgroundRes != 0) {
                    viewHolder.txView
                            .setBackgroundResource(itemBackgroundRes);
                } else {
                    viewHolder.txView
                            .setBackgroundResource(ITEM_BACKGROUNDRES);
                }
            }
