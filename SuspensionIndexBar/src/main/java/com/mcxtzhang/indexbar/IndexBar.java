package com.mcxtzhang.indexbar;
...
import com.mcxtzhang.R;
import com.mcxtzhang.indexbar.bean.BaseIndexPinyinBean;
import com.mcxtzhang.indexbar.helper.IIndexBarDataHelper;
import com.mcxtzhang.indexbar.helper.IndexBarDataHelperImpl;
...
public class IndexBar extends View {
    ...
    private void initIndexDatas() {
        if (isNeedRealIndex) {
            ...
            mIndexDatas = new ArrayList<>(Arrays.asList(INDEX_STRING));
        }
    }
    ...
    public List<? extends BaseIndexPinyinBean> getmSourceDatas() {
        return mSourceDatas;
    }
