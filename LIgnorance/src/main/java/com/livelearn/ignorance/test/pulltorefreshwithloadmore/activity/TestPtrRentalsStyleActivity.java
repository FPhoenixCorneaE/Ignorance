...
import com.livelearn.ignorance.test.pulltorefreshwithloadmore.header.RentalsSunHeaderView;
...
public class TestPtrRentalsStyleActivity extends BaseActivity {
    ...
    public void initLayout(Bundle savedInstanceState) {
        ...
        header.setPadding(0, DisplayUtils.dp2px(15), 0, DisplayUtils.dp2px(15));
        header.setUp(pflPullToRefresh);
