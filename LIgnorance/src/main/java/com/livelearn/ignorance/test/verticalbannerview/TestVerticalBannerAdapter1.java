 ...
 * Time: 下午2:05<br/>
 */
class TestVerticalBannerAdapter1 extends BaseBannerAdapter<BannerModel> {

    private List<BannerModel> mDatas;

    TestVerticalBannerAdapter1(List<BannerModel> datas) {
        super(datas);
    }

    @Override
    public View getView(VerticalBannerView parent) {
        return LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_test_vertical_banner_1, parent, false);
    }
