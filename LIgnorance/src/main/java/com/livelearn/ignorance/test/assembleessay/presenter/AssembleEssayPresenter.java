package com.livelearn.ignorance.test.assembleessay.presenter;
 ...
 */
public class AssembleEssayPresenter implements AssembleEssayContract.IAssembleEssayPresenter<AssembleEssayContract.IAssembleEssayView> {

    private AssembleEssayContract.IAssembleEssayView view;
    ...
    public AssembleEssayPresenter(AssembleEssayContract.IAssembleEssayView view) {
        this.view = view;
