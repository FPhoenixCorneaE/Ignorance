...
public class TestParallaxTitleBarListViewActivity extends BaseActivity implements ObservableScrollViewCallbacks {
    ...
    public int getLayoutResource() {
        return R.layout.activity_test_parallax_title_bar_list_view;
    }
