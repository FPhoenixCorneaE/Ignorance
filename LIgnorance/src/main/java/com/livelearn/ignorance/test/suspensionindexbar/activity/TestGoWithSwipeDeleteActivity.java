...
public class TestGoWithSwipeDeleteActivity extends BaseActivity implements AddressBookViewHolder.OnDeleteListener {
    ...
    public int getLayoutResource() {
        return R.layout.activity_test_go_with_swipe_delete;
    }
    ...
    public void setListeners() {
        mAddressBookAdapter.setSwipeEnable(true);
        mAddressBookAdapter.setOnDeleteListener(this);
    }
