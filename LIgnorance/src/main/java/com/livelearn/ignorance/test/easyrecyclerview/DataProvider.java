...
public class DataProvider {
    ...
    private static final Picture[] VIRTUAL_PICTURE = {
    ...
    public static ArrayList<Picture> getPictures(int page) {
        ...
        Collections.addAll(arrayList, VIRTUAL_PICTURE);
        return arrayList;
    }

    private static final int[] NarrowImage = {
            R.mipmap.ic_person_yy01,
            R.mipmap.ic_person_yy02,
            R.mipmap.ic_person_yy03,
            R.mipmap.ic_person_yy04,
            R.mipmap.ic_person_yy05,
            R.mipmap.ic_person_yy06,
            R.mipmap.ic_person_yy07,
            R.mipmap.ic_person_yy08,
            R.mipmap.ic_person_yy09,
    };
    ...
    public static ArrayList<Integer> getNarrowImage(int page) {
        ...
        for (int aNarrowImage : NarrowImage) {
            arrayList.add(aNarrowImage);
        }
        return arrayList;
    }
}
