...
public abstract class RecyclerHeaderFooterWrapperAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerHeaderFooterWrapperAdapter(RecyclerView.Adapter mInnerAdapter) {
