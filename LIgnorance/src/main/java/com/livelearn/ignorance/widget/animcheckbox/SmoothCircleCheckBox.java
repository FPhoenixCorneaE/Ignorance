...
package com.livelearn.ignorance.widget.animcheckbox;
...
public class SmoothCircleCheckBox extends View implements Checkable {
    ...
    public SmoothCircleCheckBox(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SmoothCircleCheckBox(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(attrs);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public SmoothCircleCheckBox(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(AttributeSet attrs) {
        ...
        TypedArray ta = getContext().obtainStyledAttributes(attrs, R.styleable.SmoothCircleCheckBox);
        int tickColor = ta.getColor(R.styleable.SmoothCircleCheckBox_scb_color_tick, COLOR_TICK);
        mAnimDuration = ta.getInt(R.styleable.SmoothCircleCheckBox_scb_duration, DEF_ANIM_DURATION);
        mFloorColor = ta.getColor(R.styleable.SmoothCircleCheckBox_scb_color_unchecked_stroke, COLOR_FLOOR_UNCHECKED);
        mCheckedColor = ta.getColor(R.styleable.SmoothCircleCheckBox_scb_color_checked, COLOR_CHECKED);
        mUnCheckedColor = ta.getColor(R.styleable.SmoothCircleCheckBox_scb_color_unchecked, COLOR_UNCHECKED);
        mStrokeWidth = ta.getDimensionPixelSize(R.styleable.SmoothCircleCheckBox_scb_stroke_width, dp2px(getContext(), 0));
        ta.recycle();
    ...
    public void setChecked(boolean checked) {
        ...
        invalidate();
        if (mListener != null) {
            mListener.onCheckedChanged(SmoothCircleCheckBox.this, mChecked);
        }
    }
    ...
    public interface OnCheckedChangeListener {
        void onCheckedChanged(SmoothCircleCheckBox checkBox, boolean isChecked);
    }
}
