package com.livelearn.ignorance.widget.flowlayout;
...
public class TagCloudView extends ViewGroup {
    ...
    private static final int DEFAULT_TEXT_BACKGROUND = R.drawable.selector_background_child_tag_cloud;
    ...
    private static final int DEFAULT_TAG_RESID = R.layout.child_tag_cloud;
