package com.livelearn.ignorance.widget.progress;
...
public class CircleProgress extends View {
    ...
    private static final int DEFAULT_CIRCLE_PROGRESS_VIEW_SIZE = 200;
    private int[] COLORS;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        int defaultSize = dpToPx(DEFAULT_CIRCLE_PROGRESS_VIEW_SIZE);
    ...
    private class EaseInOutCubicInterpolator implements TimeInterpolator {
