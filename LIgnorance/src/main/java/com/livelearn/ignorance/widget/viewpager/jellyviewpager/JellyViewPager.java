package com.livelearn.ignorance.widget.viewpager.jellyviewpager;
...
import com.livelearn.ignorance.utils.SpringSystem;
...
public class JellyViewPager extends ViewPager {
    ...
    private SparseArray<Object> objs = new SparseArray<>();
    ...
    public void setObjectForPosition(Object obj, int position) {
        objs.put(position, obj);
    }

    public View findViewFromObject(int position) {
        Object o = objs.get(position);
        if (o == null) {
            return null;
        }
