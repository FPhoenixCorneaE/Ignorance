...
public class MaterialLoginView extends FrameLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        inflater.inflate(R.layout.view_login, this, true);
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(attrs, R.styleable.MaterialLoginView, 0, 0);

        try {
            int loginViewId = a.getResourceId(R.styleable.MaterialLoginView_loginView, R.layout.view_login_default);
            inflate(getContext(), loginViewId, loginCard);
            loginView = loginCard.getChildAt(0);

            int registerViewId = a.getResourceId(R.styleable.MaterialLoginView_registerView, R.layout.view_register_default);
    ...
    private class FabAnimation extends Animation {
        private PathMeasure measure;
        private float[] pos;

        FabAnimation(Path path) {
