...
import com.livelearn.ignorance.BuildConfig;
...
public class InsLoadingView extends AppCompatImageView {
    ...
    private void praseAttrs(Context context, AttributeSet attrs) {
        ...
        int startColor = typedArray.getColor(R.styleable.InsLoadingViewAttr_ilv_start_color, mStartColor);
        int endColor = typedArray.getColor(R.styleable.InsLoadingViewAttr_ilv_end_color, mEndColor);
        int circleDuration = typedArray.getInt(R.styleable.InsLoadingViewAttr_ilv_circle_duration, mCircleDuration);
        int rotateDuration = typedArray.getInt(R.styleable.InsLoadingViewAttr_ilv_rotate_duration, mRotateDuration);
        int status = typedArray.getInt(R.styleable.InsLoadingViewAttr_ilv_status, 0);
        if (DEBUG) {
    ...
    private Paint getmBitmapPaint() {
        ...
        BitmapShader tshader = new BitmapShader(bitmap, CLAMP, CLAMP);
