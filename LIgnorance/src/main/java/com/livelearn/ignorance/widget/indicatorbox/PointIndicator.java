...
public class PointIndicator extends LinearLayout {
    ...
    //选中时的显示效果
    private int mIndicatorBackgroundResId = R.drawable.shape_circle_solidwhite;
    //未选中时的显示效果
    private int mIndicatorUnselectedBackgroundResId = R.drawable.shape_circle_solidwhite;
    //动画
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        mIndicatorBackgroundResId = typedArray.getResourceId(R.styleable.PointIndicator_indicator_selected_src, R.drawable.shape_circle_solidwhite);
        mIndicatorUnselectedBackgroundResId = typedArray.getResourceId(R.styleable.PointIndicator_indicator_unselected_src, R.drawable.shape_circle_solidwhite);
    ...
    private void checkIndicatorConfig(Context context) {
        ...
        mIndicatorBackgroundResId = (mIndicatorBackgroundResId == 0) ? R.drawable.shape_circle_solidwhite : mIndicatorBackgroundResId;
        mIndicatorUnselectedBackgroundResId = (mIndicatorUnselectedBackgroundResId == 0) ? R.drawable.shape_circle_solidwhite : mIndicatorBackgroundResId;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mOrientation == HORIZONTAL) {
            resultWidth = Utils.getAdjustedSize(mIndicatorNum * dip2px(mIndicatorWidth) + (mIndicatorNum + 1) * mIndicatorMargin * 2, widthMeasureSpec);
            resultHeight = Utils.getAdjustedSize(dip2px(mIndicatorHeight) + 2 * mIndicatorMargin, heightMeasureSpec);
        } else {
            resultWidth = Utils.getAdjustedSize(dip2px(mIndicatorWidth) + 2 * mIndicatorMargin, widthMeasureSpec);
            resultHeight = Utils.getAdjustedSize(mIndicatorNum * dip2px(mIndicatorHeight) + (mIndicatorNum + 1) * mIndicatorMargin * 2, heightMeasureSpec);
        }
    ...
    private void createIndicators() {
        ...
        int currentItem = convertForInifite(mLastPosition);
