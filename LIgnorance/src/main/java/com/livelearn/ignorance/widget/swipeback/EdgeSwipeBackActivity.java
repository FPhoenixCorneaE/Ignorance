...
/**
 * EdgeSwipeBackActivity
 * Created by YoKeyword on 16/4/19.
 */
public class EdgeSwipeBackActivity extends AppCompatActivity {
    ...
    protected void onPostCreate(Bundle savedInstanceState) {
        ...
        mEdgeSwipeBackLayout.attachToActivity(this);
    }

    @Override
    public View findViewById(int id) {
        View view = super.findViewById(id);
        if (view == null && mEdgeSwipeBackLayout != null) {
            return mEdgeSwipeBackLayout.findViewById(id);
        }
        return view;
    }
    ...
    void onActivityCreate() {
        ...
        mEdgeSwipeBackLayout = new EdgeSwipeBackLayout(this);
