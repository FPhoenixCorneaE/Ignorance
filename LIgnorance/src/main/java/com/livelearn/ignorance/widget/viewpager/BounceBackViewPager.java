...
public class BounceBackViewPager extends ViewPager {
    ...
    private void init(AttributeSet attrs) {
        ...
        mOverscrollTranslation = a.getDimension(R.styleable.BounceBackViewPager_bounceback_overscroll_translation, DEFAULT_OVERSCROLL_TRANSLATION);
        mOverscrollAnimationDuration = a.getInt(R.styleable.BounceBackViewPager_bounceback_overscroll_animation_duration, DEFAULT_OVERSCROLL_ANIMATION_DURATION);
        a.recycle();
    }
