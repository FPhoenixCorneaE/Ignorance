 ...
 */
public class EdgeSwipeBackLayout extends FrameLayout {
    /**
    ...
    private EdgeSwipeBackFragment mFragment;
    ...
    public EdgeSwipeBackLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public EdgeSwipeBackLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void setFragment(EdgeSwipeBackFragment fragment, View view) {
    ...
    public void attachToFragment(EdgeSwipeBackFragment edgeSwipeBackFragment, View view) {
        addView(view);
        setFragment(edgeSwipeBackFragment, view);
    }
    ...
    private class ViewDragCallback extends ViewDragHelper.Callback {
        ...
        public void onViewPositionChanged(View changedView, int left, int top, int dx, int dy) {
            ...
            if (mScrollPercent > 1) {
                if (mFragment != null) {
                    if (mPreFragment instanceof EdgeSwipeBackFragment) {
                        ((EdgeSwipeBackFragment) mPreFragment).mLocking = true;
                    }
                    ...
                    if (mPreFragment instanceof EdgeSwipeBackFragment) {
                        ((EdgeSwipeBackFragment) mPreFragment).mLocking = false;
                    }
                } else {
