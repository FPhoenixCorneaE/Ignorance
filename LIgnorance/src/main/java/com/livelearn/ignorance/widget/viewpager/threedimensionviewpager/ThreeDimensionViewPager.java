package com.livelearn.ignorance.widget.viewpager.threedimensionviewpager;
 ...
 * 3D效果的ViewPager
 */
public class ThreeDimensionViewPager extends ViewPager {
    /**
    ...
    public ThreeDimensionViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void init(AttributeSet attrs) {
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.ThreeDimensionViewPager);
        mOverscrollRotation = a.getFloat(R.styleable.ThreeDimensionViewPager_overscroll_rotation, DEFAULT_OVERSCROLL_ROTATION);
        mSwipeRotation = a.getFloat(R.styleable.ThreeDimensionViewPager_swipe_rotation, DEFAULT_SWIPE_ROTATION);
        mSwipeTranslation = a.getInt(R.styleable.ThreeDimensionViewPager_swipe_translation, DEFAULT_SWIPE_TRANSLATION);
        mOverscrollTranslation = a.getInt(R.styleable.ThreeDimensionViewPager_overscroll_translation,
                DEFAULT_OVERSCROLL_TRANSLATION);
        mOverscrollAnimationDuration = a.getInt(R.styleable.ThreeDimensionViewPager_overscroll_animation_duration,
                DEFAULT_OVERSCROLL_ANIMATION_DURATION);
        mAnimateAlpha = a.getBoolean(R.styleable.ThreeDimensionViewPager_animate_alpha, DEFAULT_ANIMATE_ALPHA);
        a.recycle();
    }
    ...
    public void setmScrollListener(OnPageChangeListener mScrollListener) {
