package com.livelearn.ignorance.widget.cbprogressBar;
...
//	private Paint mTextpaint;
    ...
    public CBProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        percenttextcolor = array.getColor(R.styleable.CBProgressBar_percentTextColor, percenttextcolor);
        ...
        percenttextsize = (int) array.getDimension(R.styleable.CBProgressBar_percentTextSize, percenttextsize);
        strokeWidth = (int) array.getDimension(R.styleable.CBProgressBar_strokeWidth, strokeWidth);
        rectRound = (int) array.getDimension(R.styleable.CBProgressBar_rectRound, rectRound);
        orientation = array.getInteger(R.styleable.CBProgressBar_cbprogressBarStyle, STYLE_HORIZONTAL);
