package com.livelearn.ignorance.widget.loaderview;
...
public class LoaderTextView extends TextView implements LoaderView {
    ...
    private void init(AttributeSet attrs) {
        ...
        loaderController.setWidthWeight(typedArray.getFloat(R.styleable.LoaderView_width_weight, LoaderConstant.MAX_WEIGHT));
        loaderController.setHeightWeight(typedArray.getFloat(R.styleable.LoaderView_height_weight, LoaderConstant.MAX_WEIGHT));
        typedArray.recycle();
    }
