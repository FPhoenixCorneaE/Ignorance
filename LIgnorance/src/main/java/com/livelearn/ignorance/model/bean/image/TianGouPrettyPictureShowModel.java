...
public class TianGouPrettyPictureShowModel implements Serializable {
    ...
    public static TianGouPrettyPictureShowModel objectFromData(String str) {

        return new Gson().fromJson(str, TianGouPrettyPictureShowModel.class);
    }
    ...
    @Override
    public String toString() {
        return "TianGouPrettyPictureShowModel{" +
                "count=" + count +
                ", fcount=" + fcount +
