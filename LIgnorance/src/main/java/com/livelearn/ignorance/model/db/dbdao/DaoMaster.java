...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(Database db, boolean ifNotExists) {
        ...
        DouBanBookCollectionDao.createTable(db, ifNotExists);
        HospitalDao.createTable(db, ifNotExists);
        LongTimeBookCollectionDao.createTable(db, ifNotExists);
        ProvinceCityDao.createTable(db, ifNotExists);
    ...
    public static void dropAllTables(Database db, boolean ifExists) {
        ...
        DouBanBookCollectionDao.dropTable(db, ifExists);
        HospitalDao.dropTable(db, ifExists);
        LongTimeBookCollectionDao.dropTable(db, ifExists);
        ProvinceCityDao.dropTable(db, ifExists);
    ...
    public DaoMaster(Database db) {
        ...
        registerDaoClass(DouBanBookCollectionDao.class);
        registerDaoClass(HospitalDao.class);
        registerDaoClass(LongTimeBookCollectionDao.class);
        registerDaoClass(ProvinceCityDao.class);
