...
public class ItemView extends RelativeLayout {
     ...
     * @param isShow 是否显示
     */
    public void setArrowStyle(int width, int height, int resId, boolean isShow, int arrowMarginRight) {
        ...
        ViewGroup.LayoutParams layoutParams = arrowImg.getLayoutParams();
     ...
     * @param resId 资源ID
     */
    public void setArrowStyle(int width, int height, int resId, int arrowMarginRight) {
    ...
    public void setShowStyle(BaseItemLayout3.Mode mode) {
        ...
        } else if (mode == BaseItemLayout3.Mode.SWITCH) {
