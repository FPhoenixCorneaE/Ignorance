...
public class AppApplicationManager {
    ...
    public static String getVersionName(Context context) {
        ...
        try {
            ...
            AppLogMessageManager.e("AppApplicationManager-->>getVerName()", e.getMessage() + "获取本地Apk版本名称失败！");
            e.printStackTrace();
        }
        return verName;
    }
    ...
    public static int getVersionCode(Context context) {
        ...
        try {
            ...
            AppLogMessageManager.e("AppApplicationManager-->>getVerCode()", e.getMessage() + "获取本地Apk版本号失败！");
            e.printStackTrace();
        }
        return verCode;
    }
    ...
    public static String getAppSign(Context context, String packageName) {
        try {
            ...
            throw new RuntimeException(AppApplicationManager.class.getName() + "the " + packageName + "'s application not found");
        }
    }
        ...
        if (context != null && !TextUtils.isEmpty(permission)) {
            try {
                ...
                if (packageManager != null) {
                    ...
                    Log.d("CommonUtils", "Have you  declared permission " + permission + " in AndroidManifest.xml ?");
                }
            } catch (Exception e) {
                e.printStackTrace();
                return false;
