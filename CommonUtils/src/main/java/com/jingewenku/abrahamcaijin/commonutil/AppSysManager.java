...
public class AppSysManager {
    ...
    public static String getSysSdk() {
        ...
        AppLogMessageManager.i("AppSysManager-->>getSysLanguage", sdkVersion);
        return sdkVersion;
    }
    ...
    public static String getSysLanguage() {
        ...
        AppLogMessageManager.i("AppSysManager-->>getSysLanguage", language);
        return language;
    }
    ...
    public static String getSysModel() {
        ...
        AppLogMessageManager.i("AppSysManager-->>getSysModel", model);
        return model;
    }
    ...
    public static String getSysRelease() {
        ...
        AppLogMessageManager.i("AppSysManager-->>getSysRelease", release);
        return release;
    }
    ...
    public static String getSysSIMSerialNum(Context content) {
        ...
        AppLogMessageManager.i("AppSysManager-->>getSysSIMSerialNum", simSerialNumber);
    ...
    public static String getSysCPUSerialNum() {
        ...
        try {
            ...
            e.printStackTrace();
            AppLogMessageManager.e("AppSysManager-->>getSysCPUSerialNum", e.getMessage().toString());
        }
        return cpuSerialNum;
    }
    ...
    private static TelephonyManager getSysTelephonyManager(Context content) {
        ...
        AppLogMessageManager.i("AppSysManager-->>getSysTelephonyManager", telephonyManager + "");
    ...
    public static String getSysTelephoneSerialNum(Context content) {
        ...
        AppLogMessageManager.i("AppSysManager-->>getSysTelephoneSerialNum", deviceId + "");
        return deviceId;
    }
    ...
    public static String getSysCarrier(Context content) {
        ...
        AppLogMessageManager.i("AppSysManager-->>getSysCarrier", moblieType);
        return moblieType;
    }
    ...
    public static Integer getSysPhoneState(Context context) {
        ...
        AppLogMessageManager.i("AppSysManager-->>getSysPhoneState", callState + "");
        return callState;
    }
    ...
    public static CellLocation getSysPhoneLoaction(Context context) {
        ...
        AppLogMessageManager.i("AppSysManager-->>getSysPhoneLoaction", cellLocation + "");
        return cellLocation;
    }
    ...
    public static String getSysDeviceSoftVersion(Context context) {
        ...
        AppLogMessageManager.i("AppSysManager-->>getSysDeviceSoftVersion", deviceSoftwareVersion + "");
    ...
    public static String getSysPhoneNumber(Context context) {
        ...
        AppLogMessageManager.i("AppSysManager-->>getSysPhoneNumber", phoneNumber + "");
        return phoneNumber;
    }
    ...
    public static String getSysSimCode(Context context) {
        ...
        AppLogMessageManager.i("AppSysManager-->>getSysSimCode", code + "");
        return code;
    }
    ...
    public static String getSysSimPrivatorName(Context context) {
        ...
        AppLogMessageManager.i("AppSysManager-->>getSysSimPrivatorName", simOperatorName);
    ...
    public static String getSysUserPhoneId(Context context) {
        ...
        AppLogMessageManager.i("AppSysManager-->>getSysUserPhoneId", subscriberId);
        return subscriberId;
    }
    ...
    public static DisplayMetrics getSysDisplayMetrics(Activity activity) {
        ...
        AppLogMessageManager.i("AppSysManager-->>getSysDisplayMetrics", "获取屏幕管理对象为：" + displayMetrics);
    ...
    public static int[] getScreenDispaly(Context context) {
        ...
        AppLogMessageManager.i("AppSysManager-->>getScreenDispaly-->>width", "获取屏幕宽度为：" + width);
        AppLogMessageManager.i("AppSysManager-->>getScreenDispaly-->>height", "获取屏幕高度为：" + height);
    ...
    public static Integer getSysScreenWidth(Context context) {
        ...
        AppLogMessageManager.i("AppSysManager-->>getSysScreenWidth", "获取屏幕宽度为：" + displayMetrics.widthPixels);
    ...
    public static Integer getSysScreenHeight(Context context) {
        ...
        DisplayMetrics displayMetrics = new DisplayMetrics();
        wm.getDefaultDisplay().getMetrics(displayMetrics);
        AppLogMessageManager.i("AppSysManager-->>getSysScreenHeight", "获取屏幕高度为：" + displayMetrics.heightPixels);
    ...
    public static Integer getSysScreenStatusHeight(Context context) {
        ...
        try {
            ...
            AppLogMessageManager.i("AppSysManager-->>getSysScreenStatusHeight", "获取屏幕状态栏高度为：" + statusHeight);
        } catch (Exception e) {
            e.printStackTrace();
            AppLogMessageManager.e("AppSysManager-->>getSysScreenStatusHeight", "获取屏幕状态栏高度失败！" + e.getMessage());
        }
        return statusHeight;
    }
    ...
    public static Integer getSysDefaultThreadPoolSize() {
        ...
        AppLogMessageManager.i("AppSysManager-->>getSysDefaultThreadPoolSize", availableProcessors + "");
    ...
    public static Integer getSysSampleSize(BitmapFactory.Options options, int minSideLength, int maxNumOfPixels) {
        ...
        AppLogMessageManager.i("AppSysManager-->>getSysSampleSize", roundedSize + "");
        return roundedSize;
    }
    ...
    public String getSysLocalIpAddress() {
        ...
        try {
            ...
            e.printStackTrace();
            AppLogMessageManager.e("AppSysManager-->>getSysLocalIpAddress", e.getMessage().toString());
        }
        AppLogMessageManager.i("AppSysManager-->>getSysLocalIpAddress", hostAddress);
        return hostAddress;
    }
