 ...
 * @version: 1.0.0
 */
public class AppCharacterParserHelper {

    private static AppCharacterParserHelper appcharacterParserHelper = new AppCharacterParserHelper();
    ...
    //单例对象
    public static AppCharacterParserHelper getAppCharacterParserInstance() {
        return appcharacterParserHelper;
    }
    ...
    private int getChsAscii(String chs) {
        ...
        try {
            ...
            e.printStackTrace();
            AppLogMessageManager.e("AppCharacterParserHelper-->>getChsAscii", e.getMessage());
        }
        return asc;
    }
